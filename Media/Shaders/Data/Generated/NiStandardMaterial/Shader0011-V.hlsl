#line 2 "D:\Emergent\Gamebryo-LightSpeed-3.2-Source\Media\Shaders\Data\Generated\\NiStandardMaterial\Shader0011-V.hlsl"
/*
Shader description:
TRANSFORM = 1
OUTPUTWORLDPOS = 0
...
Output Main(Input In)
{
    ...
    float4x4 SkinBoneTransform_CallOut1;
    TransformSkinnedPosition(In.Position, In.BlendIndices, In.BlendWeights, 
        g_SkinBoneMatrix3, WorldPos_CallOut1, SkinBoneTransform_CallOut1);
    ...
    TransformNormal(In.Normal, SkinBoneTransform_CallOut1, WorldNrm_CallOut3);
    ...
    Light(WorldPos_CallOut1, VectorOut_CallOut4, int(0), bool(false), 
